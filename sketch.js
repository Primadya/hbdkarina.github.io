/*
 * b'day card
 * created: 3 januari 2021
 * d-day: 29 januari 2021 🎉
 * 
 */
...
var name = "Karina Diva Alifia Harsono";
var tambahan = "Serta mulia, semoga di Tahun ini diberi kemudahan. AAMIIN"
var sfxPop;
...
function draw() {
	...
	// teks tambahan
	text(tambahan, imgx + (mouseX - width/2) /30, imgY - 100 + (mouseY - height / 2/ 30);
	pop();
